...
export default function PropertyCard({
  ...
  const property = {
    ...
    image,
    zone,
    description: "This beautiful property offers modern amenities in a prime location. The spacious rooms and contemporary design make it perfect for comfortable living.",
    yearBuilt: 2020,
