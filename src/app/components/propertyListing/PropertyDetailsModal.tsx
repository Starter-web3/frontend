// components/propertyListing/PropertyDetailsModal.tsx
"use client"
...
import { Modal } from "@/src/ui/modal" // You'll need a modal component
          ...
          <div className="absolute bottom-4 left-4 right-4 flex gap-2 overflow-x-auto">
            {propertyImages.map((img, index) => (
              <button
                ...
                className={`w-16 h-16 rounded-md overflow-hidden border-2 ${currentImage === img ? 'border-purple-400' : 'border-transparent'}`}
              >
                <Image
                  src={img}
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-300">
              {property.description || "This beautiful property offers modern amenities in a prime location. The spacious rooms and contemporary design make it perfect for comfortable living. Located in a secure neighborhood with easy access to major roads and amenities."}
            </p>
          </div>
