...
//         <h1 className="text-2xl font-semibold text-white text-center mb-10">Who Are You on ProptyChain?</h1>
...
//           className="w-full py-2.5 text-white font-medium bg-[#1f1429] border border-[#ffffff20] rounded-md hover:bg-[#2a1a3e] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#1a0e2e] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
//         >
//           Save
//         </button>
