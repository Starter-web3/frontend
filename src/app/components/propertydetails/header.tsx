...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-[#16091D] backdrop-blur-sm border-b border-gray-800"
    ...
    >
      <div className="container mx-auto px-4 max-w-6xl flex justify-between items-center h-16">
        <Link href="/listings" className="flex items-center text-sm text-gray-400 hover:text-white transition-colors">
